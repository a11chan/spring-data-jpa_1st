...
@SpringBootTest
@Transactional //JPA의 모든 데이터 변경은 Tx 내에서 이뤄져야 하기 때문에 추가
...
//        foundMember1.setUsername("member!!!!");
        ...
        long afterDeletedCount = memberJpaRepository.count();
    ...
    public void findByUserNameAndAgeGreaterThan() {
        ...
        List<Member> result = memberJpaRepository.findByUsernameAndAgeGreaterThan("BBB", 10);
